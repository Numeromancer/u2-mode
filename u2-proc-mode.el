;; proc-mode.el -- Copyright (C) 1999 Pat Thoyts <p...@zsplat.freeserve.co.uk>
;;
;; Major mode for working with Proc files in EMACS.
;;
;; Author: Pat Thoyts <p...@zsplat.freeserve.co.uk>
;; Version: 1.10   (27 Aug 1999)
;; Maintainer: Pat Thoyts <p...@zsplat.freeserve.co.uk>
;; Keywords: languages
;;
;; ----------------------------------------------------------------------
;;
;; Copyright (C) 1999 Pat Thoyts <p...@zsplat.freeserve.co.uk>
;;
...
;;  Added to u2-mode. Time-stamp: <2006-01-26 13:14:15 timothy>
;;
;;
;;; INSTALLATION
;;  ------------
...
(defconst proc-mode-help-address "uniba...@zsplat.freeserve.co.uk"
...
;;
;; $Log$
;; Revision 1.1  2006/08/09 19:18:23  numeromancer
